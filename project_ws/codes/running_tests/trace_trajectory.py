...
import math
import numpy as np
import lib_stoch_creep_3D as stoch
import common_paths
...
# # Straight Line
# x = np.array([i/100 for i in range(5000)])
# y = np.zeros((5000))

# # Circle
# r = 10
# x = [r*math.cos(math.pi*(i/10 - 90)/180) for i in range(3800)]
# y = [r*math.sin(math.pi*(i/10 - 90)/180)+10 for i in range(3800)]
